  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground rounded-md font-normal text-[0.8rem] select-none text-center h-9 flex items-center justify-center",
        ...
        day: cn(
          "relative h-9 p-0 text-center text-sm [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md group/day select-none",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <MdKeyboardArrowLeft className={cn("size-4", className)} {...props} />
            )
          }
          ...
          return (
            <MdKeyboardArrowDown className={cn("size-4", className)} {...props} />
          )
        },
