...
const translations = {
  en: {
    ...
    'operation.searchPlaceholder': 'Search by admin, chamber, patient name, operation type, phone, date, time or amount',
    'operation.adminName': 'Admin Name',
    ...
    'operation.selectAdmin': 'Select Admin',
    'operation.selectChamber': 'Select Chamber',
    'operation.selectAdminFirst': 'Select admin first',
    ...
    'operation.adminRequired': 'Admin selection is required',
    ...
    'expenditure.searchPlaceholder': 'Search by admin, chamber, expenditure details or amount',
    'expenditure.adminName': 'Admin Name',
    ...
    'expenditure.selectAdmin': 'Select Admin',
    'expenditure.selectChamber': 'Select Chamber',
    'expenditure.selectAdminFirst': 'Select admin first',
    ...
    'expenditure.adminRequired': 'Admin selection is required',
    ...
    'deposit.searchPlaceholder': 'Search by admin, chamber, account or amount',
    'deposit.adminName': 'Admin Name',
    ...
    'deposit.selectAdmin': 'Select Admin',
    'deposit.selectChamber': 'Select Chamber',
    'deposit.selectAccount': 'Select Account',
    'deposit.selectAdminFirst': 'Select admin first',
    ...
    'deposit.adminRequired': 'Admin selection is required',
    ...
    'account.searchPlaceholder': 'Search by admin, account type, organization or account number',
    'account.adminName': 'Admin Name',
    ...
    'account.selectAdmin': 'Select Admin',
    'account.selectAccountType': 'Select Account Type',
    'account.selectAdminFirst': 'Select admin first',
    ...
    'account.adminRequired': 'Admin selection is required',
  ...
  bn: {
    ...
    'operation.searchPlaceholder': 'অ্যাডমিন, চেম্বার, রোগীর নাম, অপারেশনের ধরন, ফোন, তারিখ, সময় বা পরিমাণ দিয়ে খুঁজুন',
    'operation.adminName': 'অ্যাডমিনের নাম',
    ...
    'operation.selectAdmin': 'অ্যাডমিন নির্বাচন করুন',
    'operation.selectChamber': 'চেম্বার নির্বাচন করুন',
    'operation.selectAdminFirst': 'প্রথমে অ্যাডমিন নির্বাচন করুন',
    ...
    'operation.adminRequired': 'অ্যাডমিন নির্বাচন প্রয়োজন',
    ...
    'expenditure.searchPlaceholder': 'অ্যাডমিন, চেম্বার, ব্যয়ের বিবরণ বা পরিমাণ দিয়ে খুঁজুন',
    'expenditure.adminName': 'অ্যাডমিনের নাম',
    ...
    'expenditure.selectAdmin': 'অ্যাডমিন নির্বাচন করুন',
    'expenditure.selectChamber': 'চেম্বার নির্বাচন করুন',
    'expenditure.selectAdminFirst': 'প্রথমে অ্যাডমিন নির্বাচন করুন',
    ...
    'expenditure.adminRequired': 'অ্যাডমিন নির্বাচন প্রয়োজন',
    ...
    'deposit.searchPlaceholder': 'অ্যাডমিন, চেম্বার, অ্যাকাউন্ট বা পরিমাণ দিয়ে খুঁজুন',
    'deposit.adminName': 'অ্যাডমিনের নাম',
    ...
    'deposit.selectAdmin': 'অ্যাডমিন নির্বাচন করুন',
    'deposit.selectChamber': 'চেম্বার নির্বাচন করুন',
    'deposit.selectAccount': 'অ্যাকাউন্ট নির্বাচন করুন',
    'deposit.selectAdminFirst': 'প্রথমে অ্যাডমিন নির্বাচন করুন',
    ...
    'deposit.adminRequired': 'অ্যাডমিন নির্বাচন প্রয়োজন',
    ...
    'account.searchPlaceholder': 'অ্যাডমিন, অ্যাকাউন্ট টাইপ, প্রতিষ্ঠান বা অ্যাকাউন্ট নম্বর দিয়ে খুঁজুন',
    'account.adminName': 'অ্যাডমিনের নাম',
    ...
    'account.selectAdmin': 'অ্যাডমিন নির্বাচন করুন',
    'account.selectAccountType': 'অ্যাকাউন্ট টাইপ নির্বাচন করুন',
    'account.selectAdminFirst': 'প্রথমে অ্যাডমিন নির্বাচন করুন',
    ...
    'account.adminRequired': 'অ্যাডমিন নির্বাচন প্রয়োজন',
